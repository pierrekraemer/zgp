...
pub fn addDataWithUniqueRandomName(sm: *SurfaceMesh, rng: *std.Random.DefaultPrng, comptime cell_type: CellType, comptime T: type, prefix: []const u8) !CellData(cell_type, T) {
    var buf: [64]u8 = undefined;
    while (true) {
        const suffix = rng.random().int(u32);
